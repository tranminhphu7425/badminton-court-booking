...
const LocationCard = ({
  ...
  return (
   <div
   onClick={onClick}
  className="h-full group block focus:outline-none focus-visible:ring-2 focus-visible:ring-green-500 focus-visible:ring-offset-2 rounded-xl"
>
  {mode === 0 ? (
    // CARD VIEW
    <div className="flex flex-col h-full bg-white dark:bg-gray-800 rounded-xl shadow-sm hover:shadow-lg transition-all duration-300 ease-in-out overflow-hidden border border-gray-100 dark:border-gray-700 group-hover:border-green-500 dark:group-hover:border-green-400 group-active:scale-[0.98]">
