...
const CourtCard = ({ name, image, location, price, rating, link, badges }) => {
  return (
    <Link to={link} className="group block focus:outline-none focus-visible:ring-2 focus-visible:ring-green-500 focus-visible:ring-offset-2 rounded-xl">
  <div className="
  ...
  ">
    ...
    <div className="p-5">
      ...
      {/* Location with improved icon styling */}
      ...
      <div className="flex items-center justify-between mt-4 pt-3 border-t border-gray-100 dark:border-gray-700">
        ...
        <div className="flex items-center 
          ...
          {badges && (
            <div className='mr-1.5'>{badges}</div>
          )}
