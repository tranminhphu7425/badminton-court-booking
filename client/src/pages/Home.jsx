...
const Home = () => {
  ...
  <section className="hero-section bg-green-700 dark:bg-green-800 text-white py-20">
    <div className="container mx-auto px-4">
      <div className="max-w-2xl mx-auto text-center">
        <h1 className="text-4xl md:text-5xl font-bold mb-6 dark:text-white">Đặt Sân Thể Thao Dễ Dàng</h1>
        <p className="text-xl mb-8 dark:text-gray-200">Tìm và đặt sân bóng đá, cầu lông, tennis,... nhanh chóng với giá tốt nhất</p>
  ...
  <Section>
    <div className="pt-16 pb-4 bg-gray-50 dark:bg-gray-700 container mx-auto px-4">
      <div className="text-center mb-12">
        <h2 className="text-3xl font-bold text-gray-800 dark:text-white mb-4">Môn Thể Thao Phổ Biến</h2>
        <p className="text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">Chọn môn thể thao yêu thích của bạn và bắt đầu đặt sân ngay</p>
      </div>
  ...
  <Section>
    <div className="container mx-auto p-4">
      <div className="flex justify-between items-center mb-12">
        <div>
          <h2 className="text-3xl font-bold text-gray-800 dark:text-white mb-2">Sân Nổi Bật</h2>
          <p className="text-gray-600 dark:text-gray-300">Các sân thể thao được đặt nhiều nhất</p>
        </div>
        <a href="/sports/all" className="text-green-600 hover:text-green-700 dark:text-green-400 dark:hover:text-green-300 font-medium flex items-center">
  ...
  <Section>
    <div className="bg-gray-50 dark:bg-gray-700 container mx-auto px-4 py-8">
      <div className="text-center mb-12">
        <h2 className="text-3xl font-bold text-gray-800 dark:text-white mb-4">Cách Đặt Sân</h2>
        <p className="text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">Chỉ với 3 bước đơn giản để có sân chơi như ý</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        <div className="text-center p-6">
          ...
          <p className="text-gray-600 dark:text-gray-300">Chọn môn thể thao, địa điểm và thời gian bạn muốn chơi</p>
        </div>
        ...
        <div className="text-center p-6">
          ...
          <p className="text-gray-600 dark:text-gray-300">Xác nhận thông tin và thanh toán đơn giản</p>
        </div>
        ...
        <div className="text-center p-6">
          ...
          <p className="text-gray-600 dark:text-gray-300">Đến sân và tận hưởng trận đấu của bạn</p>
        </div>
      </div>
    </div>
  </Section>
  ...
  <Section>
    <div className="container mx-auto p-4">
      <div className="text-center mb-12">
        <h2 className="text-3xl font-bold text-gray-800 dark:text-white mb-4">Khách Hàng Nói Gì</h2>
        <p className="text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">Những phản hồi từ khách hàng đã sử dụng dịch vụ của chúng tôi</p>
      </div>
  ...
  <Section>
    <div className="py-16 bg-green-700 dark:bg-green-800 text-white container mx-auto px-4 text-center">
      <h2 className="text-3xl font-bold mb-6 dark:text-white">Sẵn sàng đặt sân thể thao?</h2>
      <p className="text-xl mb-8 max-w-2xl mx-auto dark:text-gray-200">Đăng ký ngay để nhận ưu đãi 10% cho lần đặt sân đầu tiên</p>
