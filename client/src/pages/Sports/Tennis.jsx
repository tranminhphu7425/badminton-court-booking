...
const Tennis = () => {
  ...
  useEffect(() => {
    const mockCourts = [
      ...
      {
        id: 3,
        name: 'Sân quần vợt Thủ Đức',
        image: '/images/tennis-3.jpg',
      ...
      {
        id: 4,
        name: 'Sân quần vợt Gò Vấp',
        image: '/images/tennis-4.jpg',
      ...
      <section className="hero-section bg-green-700 text-white py-16">
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row items-center justify-between">
            <div>
              <h1 className="text-3xl md:text-4xl font-bold mb-2">Sân Quần Vợt</h1>
              <p className="text-lg">Tìm và đặt sân quần vợt ưng ý nhất</p>
            </div>
            ...
            <>
              <div className="flex justify-between items-center mb-8">
                <h2 className="text-xl font-semibold text-gray-800">
                  {filteredCourts.length} sân quần vợt phù hợp
                </h2>
                <div className="flex items-center">
