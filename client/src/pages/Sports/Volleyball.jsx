...
const Volleyball = () => {
  ...
  useEffect(() => {
    const mockCourts = [
      ...
      {
        id: 2,
        name: 'Sân bóng chuyền Quận 7',
        image: '/images/volleyball-2.jpg',
      ...
      {
        id: 3,
        name: 'Sân bóng chuyền Thủ Đức',
        image: '/images/volleyball-3.jpg',
      ...
      {
        id: 4,
        name: 'Sân bóng chuyền Gò Vấp',
        image: '/images/volleyball-4.jpg',
      ...
      <section className="hero-section bg-green-700 text-white py-16">
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row items-center justify-between">
            <div>
              <h1 className="text-3xl md:text-4xl font-bold mb-2">Sân Bóng Chuyền</h1>
              <p className="text-lg">Tìm và đặt sân bóng chuyền ưng ý nhất</p>
            </div>
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row gap-4">
            <div className="relative flex-grow">
              <input
                type="text"
                placeholder="Tìm sân bóng chuyền..."
            ...
            <>
              <div className="flex justify-between items-center mb-8">
                <h2 className="text-xl font-semibold text-gray-800">
                  {filteredCourts.length} sân bóng chuyền phù hợp
                </h2>
                <div className="flex items-center">
