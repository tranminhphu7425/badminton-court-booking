      ...
      <section className="hero-section bg-green-700 text-white py-16">
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row items-center justify-between">
            <div>
              <h1 className="text-3xl md:text-4xl font-bold mb-2">Sân Cầu Lông</h1>
              <p className="text-lg">Tìm và đặt sân cầu lông ưng ý nhất</p>
            </div>
            ...
            <>
              <div className="flex justify-between items-center mb-8">
                <h2 className="text-xl font-semibold text-gray-800">
                  {filteredCourts.length} sân cầu lông phù hợp
                </h2>
                <div className="flex items-center">
